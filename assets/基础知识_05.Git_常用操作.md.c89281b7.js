import{_ as t}from"./chunks/articleMeta.vue_vue_type_script_setup_true_lang.88bb6f08.js";import{_ as c,c as i,b as n,w as r,d as l,e as d,a as C,r as y,o as D}from"./app.76f071c4.js";const v=JSON.parse('{"title":"常用","description":"","frontmatter":{},"headers":[{"level":1,"title":"常用","slug":"常用","link":"#常用","children":[{"level":2,"title":"分支操作","slug":"分支操作","link":"#分支操作","children":[]},{"level":2,"title":"版本对比","slug":"版本对比","link":"#版本对比","children":[]},{"level":2,"title":"git pull 撤销","slug":"git-pull-撤销","link":"#git-pull-撤销","children":[]},{"level":2,"title":"git 修改 .gitignore 文件使其生效","slug":"git-修改-gitignore-文件使其生效","link":"#git-修改-gitignore-文件使其生效","children":[]},{"level":2,"title":"clone 最新的一个提交，不含历史 commit","slug":"clone-最新的一个提交-不含历史-commit","link":"#clone-最新的一个提交-不含历史-commit","children":[]},{"level":2,"title":"撤销 git add","slug":"撤销-git-add","link":"#撤销-git-add","children":[]}]}],"relativePath":"基础知识/05.Git/常用操作.md","lastUpdated":1670836236000}'),A={name:"基础知识/05.Git/常用操作.md"},g=l("h1",{id:"常用",tabindex:"-1"},[d("常用 "),l("a",{class:"header-anchor",href:"#常用","aria-hidden":"true"},"#")],-1),h=C(`<h2 id="分支操作" tabindex="-1">分支操作 <a class="header-anchor" href="#分支操作" aria-hidden="true">#</a></h2><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki"><code><span class="line"><span style="color:#676E95;">// 查看提交记录，获取 CommitID</span></span>
