import{_ as p,c as r,b as n,w as c,d as l,e as i,a as d,r as C,o as A,f as u}from"./app.ff5bb764.js";const f=JSON.parse('{"title":"canvas download时显示“网络错误”","description":"","frontmatter":{"title":"canvas download时显示“网络错误”","author":"teemwu","date":"2018/05/03 18:42","isPublished":true,"categories":["Javascript","报错"],"tags":null,"wordCount":248},"headers":[{"level":1,"title":"canvas download时显示“网络错误”","slug":"canvas-download时显示-网络错误","link":"#canvas-download时显示-网络错误","children":[]}],"relativePath":"随笔/2018/canvas download时显示“网络错误”.md","lastUpdated":1672736520000}'),_={name:"随笔/2018/canvas download时显示“网络错误”.md"},v=l("h1",{id:"canvas-download时显示-网络错误",tabindex:"-1"},[i("canvas download时显示“网络错误” "),l("a",{class:"header-anchor",href:"#canvas-download时显示-网络错误","aria-hidden":"true"},"#")],-1),m=d(`<p>在使用html2canvas截取页面的时候发现图片死活保存不到本地，chrome一直报“网络错误”，百度、谷歌无果。</p><p>后来想想，html2canvas生成的也是canvas对象，所以按这个关键字找到了解决方法。</p><p><a href="https://stackoverflow.com/questions/37135417/download-canvas-as-png-in-fabric-js-giving-network-error" target="_blank" rel="noreferrer">解决链接</a>:<a href="https://stackoverflow.com/questions/37135417/download-canvas-as-png-in-fabric-js-giving-network-error" target="_blank" rel="noreferrer">https://stackoverflow.com/questions/37135417/download-canvas-as-png-in-fabric-js-giving-network-error</a></p><p>主要出现这个问题是canvas保存图片到本地时各个浏览器像素的限制不同，所以将图片数据转换成Blob数据流下载下来就行了。</p><p>主要代码如下：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">//....前面省略      </span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,6);function D(a,s,y,h,w,g){const e=u,o=C("ClientOnly");return A(),r("div",null,[v,n(o,null,{default:c(()=>[n(e,{modelValue:a.$frontmatter,"onUpdate:modelValue":s[0]||(s[0]=t=>a.$frontmatter=t)},null,8,["modelValue"])]),_:1}),m])}const k=p(_,[["render",D]]);export{f as __pageData,k as default};
