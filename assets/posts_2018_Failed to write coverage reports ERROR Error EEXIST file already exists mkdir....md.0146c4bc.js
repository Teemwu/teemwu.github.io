import{_ as p,c as i,C as a,z as c,x as n,a as d,N as C,D as l,o as y}from"./chunks/framework.818a7516.js";const v=JSON.parse('{"title":"Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir...","description":"","frontmatter":{"title":"Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir...","author":"teemwu","date":"2018/12/04 17:27","isPublished":true,"categories":["报错"],"tags":null,"wordCount":206},"headers":[{"level":1,"title":"Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir...","slug":"failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir","link":"#failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir","children":[]}],"relativePath":"posts/2018/Failed to write coverage reports ERROR Error EEXIST file already exists mkdir....md","lastUpdated":1679454061000}'),A={name:"posts/2018/Failed to write coverage reports ERROR Error EEXIST file already exists mkdir....md"},x=n("h1",{id:"failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir",tabindex:"-1"},[d("Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir... "),n("a",{class:"header-anchor",href:"#failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir","aria-label":'Permalink to "Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir..."'},"​")],-1),m=C(`<p>配置 vue 的 jest 单元测试时报错如下：</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"> Failed to write coverage reports:</span></span>
