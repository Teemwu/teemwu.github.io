import{_ as c,c as i,C as a,z as r,x as p,a as C,N as A,D as e,o as h}from"./chunks/framework.04c7c4c6.js";const v=JSON.parse('{"title":"nginx + php + https 配置","description":"","frontmatter":{"title":"nginx + php + https 配置","author":"teemwu","date":"2019/10/10 23:23","isPublished":true,"categories":["服务器"],"tags":["nginx","php","https"],"wordCount":98},"headers":[{"level":1,"title":"nginx + php + https 配置","slug":"nginx-php-https-配置","link":"#nginx-php-https-配置","children":[]}],"relativePath":"posts/2019/nginx  php  https 配置.md","lastUpdated":1679191435000}'),d={name:"posts/2019/nginx  php  https 配置.md"},_=p("h1",{id:"nginx-php-https-配置",tabindex:"-1"},[C("nginx + php + https 配置 "),p("a",{class:"header-anchor",href:"#nginx-php-https-配置","aria-hidden":"true"},"#")],-1),y=A(`<div class="language-apache"><button title="Copy Code" class="copy"></button><span class="lang">apache</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">server {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"></span></code></pre></div><p>更改保存后需要重新加载下 nginx 配置文件</p><div class="language-apache"><button title="Copy Code" class="copy"></button><span class="lang">apache</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">nginx -s reload</span></span>
<span class="line"></span></code></pre></div>`,3);function g(s,n,D,m,u,x){const l=e("articleMeta"),t=e("ClientOnly");return h(),i("div",null,[_,a(t,null,{default:r(()=>[a(l,{modelValue:s.$frontmatter,"onUpdate:modelValue":n[0]||(n[0]=o=>s.$frontmatter=o)},null,8,["modelValue"])]),_:1}),y])}const $=c(d,[["render",g]]);export{v as __pageData,$ as default};
