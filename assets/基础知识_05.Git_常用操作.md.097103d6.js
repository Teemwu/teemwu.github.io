import{_ as o,c,b as n,w as i,d as l,e as r,a as d,r as y,o as C,f as D}from"./app.5e3fb6e7.js";const E=JSON.parse('{"title":"常用","description":"","frontmatter":{},"headers":[{"level":1,"title":"常用","slug":"常用","link":"#常用","children":[{"level":2,"title":"分支操作","slug":"分支操作","link":"#分支操作","children":[]},{"level":2,"title":"版本对比","slug":"版本对比","link":"#版本对比","children":[]},{"level":2,"title":"git pull 撤销","slug":"git-pull-撤销","link":"#git-pull-撤销","children":[]},{"level":2,"title":"git 修改 .gitignore 文件使其生效","slug":"git-修改-gitignore-文件使其生效","link":"#git-修改-gitignore-文件使其生效","children":[]},{"level":2,"title":"clone 最新的一个提交，不含历史 commit","slug":"clone-最新的一个提交-不含历史-commit","link":"#clone-最新的一个提交-不含历史-commit","children":[]},{"level":2,"title":"撤销 git add","slug":"撤销-git-add","link":"#撤销-git-add","children":[]}]}],"relativePath":"基础知识/05.Git/常用操作.md","lastUpdated":1671680872000}'),A={name:"基础知识/05.Git/常用操作.md"},g=l("h1",{id:"常用",tabindex:"-1"},[r("常用 "),l("a",{class:"header-anchor",href:"#常用","aria-hidden":"true"},"#")],-1),h=d(`<h2 id="分支操作" tabindex="-1">分支操作 <a class="header-anchor" href="#分支操作" aria-hidden="true">#</a></h2><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 查看提交记录，获取 CommitID</span></span>
...
<span class="line"></span></code></pre></div><h2 id="版本对比" tabindex="-1">版本对比 <a class="header-anchor" href="#版本对比" aria-hidden="true">#</a></h2><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki material-palenight has-diff"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 查看当前没有add 的内容修改</span></span>
...
<span class="line"></span></code></pre></div><h2 id="git-pull-撤销" tabindex="-1">git pull 撤销 <a class="header-anchor" href="#git-pull-撤销" aria-hidden="true">#</a></h2><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 查看历史变更记录</span></span>
...
<span class="line"></span></code></pre></div><h2 id="git-修改-gitignore-文件使其生效" tabindex="-1">git 修改 .gitignore 文件使其生效 <a class="header-anchor" href="#git-修改-gitignore-文件使其生效" aria-hidden="true">#</a></h2><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">git rm </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">r </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">cached </span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">  #清除缓存</span></span>
...
<span class="line"></span></code></pre></div><h2 id="clone-最新的一个提交-不含历史-commit" tabindex="-1">clone 最新的一个提交，不含历史 commit <a class="header-anchor" href="#clone-最新的一个提交-不含历史-commit" aria-hidden="true">#</a></h2><div class="language-jsx"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#A6ACCD;">git clone clonePath </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">depth</span><span style="color:#89DDFF;">=</span><span style="color:#F78C6C;">1</span></span>
<span class="line"></span></code></pre></div><h2 id="撤销-git-add" tabindex="-1">撤销 <code>git add</code> <a class="header-anchor" href="#撤销-git-add" aria-hidden="true">#</a></h2><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki material-palenight"><code><span class="line"><span style="color:#FFCB6B;">git</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">reset</span><span style="color:#A6ACCD;"> </span><span style="color:#C3E88D;">--mixed</span></span>
<span class="line"></span></code></pre></div>`,12);function m(s,a,f,u,F,b){const e=D,t=y("ClientOnly");return C(),c("div",null,[g,n(t,null,{default:i(()=>[n(e,{modelValue:s.$frontmatter,"onUpdate:modelValue":a[0]||(a[0]=p=>s.$frontmatter=p)},null,8,["modelValue"])]),_:1}),h])}const v=o(A,[["render",m]]);export{E as __pageData,v as default};
