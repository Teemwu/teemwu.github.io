import{_ as c,c as r,a as n,w as i,b as e,d,e as D,r as l,o as y}from"./app.bba8534e.js";const b=JSON.parse('{"title":"ts 排除 node_modules 目录检测无效","description":"","frontmatter":{"title":"ts 排除 node_modules 目录检测无效","author":"teemwu","date":"2021/08/06 15:52","isPublished":true,"categories":["Javascript","Webpack","报错"],"tags":null,"wordCount":213},"headers":[{"level":1,"title":"ts 排除 node_modules 目录检测无效","slug":"ts-排除-node-modules-目录检测无效","link":"#ts-排除-node-modules-目录检测无效","children":[{"level":3,"title":"参考","slug":"参考","link":"#参考","children":[]}]}],"relativePath":"posts/2021/ts 排除 node_modules 目录检测无效.md","lastUpdated":1677057861000}'),F={name:"posts/2021/ts 排除 node_modules 目录检测无效.md"},u=e("h1",{id:"ts-排除-node-modules-目录检测无效",tabindex:"-1"},[d("ts 排除 node_modules 目录检测无效 "),e("a",{class:"header-anchor",href:"#ts-排除-node-modules-目录检测无效","aria-hidden":"true"},"#")],-1),C=D(`<p>在项目中使用自己编写的组件库，运行项目时发现组件库中有些第三方包会报类型错误，提示说找不到类型包，而实际上在组件库中是安装了对应的类型包的。 根据网上的答案，只要开启 skipLibCheck，然而依旧无效：</p><div class="language-json"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#676E95;font-style:italic;">// tsconfig.json</span></span>
