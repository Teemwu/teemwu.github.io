import{_ as s,c as a,o as e,a as n}from"./app.412a2e2c.js";const x=JSON.parse('{"title":"Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir...","description":"","frontmatter":{"title":"Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir...","author":"teemwu","date":"2018/12/04 17:27","isPublished":true,"categories":["\u62A5\u9519"],"tags":null},"headers":[{"level":1,"title":"Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir...","slug":"failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir","link":"#failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir","children":[]}],"relativePath":"\u968F\u7B14/2018/Failed to write coverage reports ERROR Error EEXIST file already exists mkdir....md","lastUpdated":1670208316000}'),l={name:"\u968F\u7B14/2018/Failed to write coverage reports ERROR Error EEXIST file already exists mkdir....md"},o=n(`<h1 id="failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir" tabindex="-1">Failed to write coverage reports ERROR Error EEXIST file already exists, mkdir... <a class="header-anchor" href="#failed-to-write-coverage-reports-error-error-eexist-file-already-exists-mkdir" aria-hidden="true">#</a></h1><p>\u914D\u7F6E vue \u7684 jest \u5355\u5143\u6D4B\u8BD5\u65F6\u62A5\u9519\u5982\u4E0B\uFF1A</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki"><code><span class="line"><span style="color:#A6ACCD;"> Failed to write coverage reports:</span></span>
